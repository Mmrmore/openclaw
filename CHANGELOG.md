...
- Replies/image delivery: keep unsent `image_generate` media after successful block streaming instead of dropping the whole final payload, so captioned image replies still send the picture.
